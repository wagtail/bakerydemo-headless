export default function Footer() {
  const githubUrl = 'https://github.com/wagtail/bakerydemo';
  const mastodonUrl = 'https://fosstodon.org/@wagtail';
  const organisationUrl = 'https://wagtail.org';
          ...
          <ul className="list-inline">
            ...
            <li className="footer__icon">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Wagtail's official Mastodon account"
              >
                <svg
                  aria-hidden="true"
                  fill="currentColor"
